...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            FotosComponent.ctorParameters = function () { return [
                ...
                NgDropFilesDirective.prototype._extraerArchivos = function (archivosLista) {
                    ...
                    for (var propiedad in Object.getOwnPropertyNames(archivosLista)) {
                        ...
                        if (this._archivoPuedeSerCargado(archivoTemporal)) {
                            var nuevoArchivo = new _models_file_items__WEBPACK_IMPORTED_MODULE_2__["FileItem"](archivoTemporal);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CargaImagenesService = /** @class */ (function () {
                function CargaImagenesService(angularFirestore) {
                    this.angularFirestore = angularFirestore;
                    this.CARPETA_IMAGENES = 'img';
                }
                CargaImagenesService.prototype.cargarImagenesFirebase = function (archivos) {
                    var _this = this;
                    ...
                    var _loop_1 = function (item) {
                        ...
                        var uploadTask = storageRef
                            .child(this_1.CARPETA_IMAGENES + "/" + item.nombreArchivo)
                            .put(item.archivo);
